...
ATLAS_URL=your_mongodb_connection_stringSESSION_SECRET=your_secretCLOUD_NAME=your_cloudinary_nameCLOUD_API_KEY=your_cloudinary_keyCLOUD_API_SECRET=your_cloudinary_secretMAPTILER_API_KEY=your_maptiler_api_key
...
this is
README file for my wonderlust project in this i want to add the screen shots also so that recurters have more understanding and glims of my work
